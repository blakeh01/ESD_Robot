...
class Ui_ObjectWizard(object):
    def setupUi(self, ObjectWizard):
        ...
        self.wiz_page_method.nextId = self.branch_method
        ...
        self.wiz_page_create_primitive.nextId = lambda: 4
        ...
        self.wiz_page_import_obj.nextId = lambda: 5
        ...
        self.grp_object_offsets = QtWidgets.QGroupBox(self.wiz_page_sim_offsets)
        self.grp_object_offsets.setGeometry(QtCore.QRect(20, 80, 211, 111))
        ...
        self.btn_set = QtWidgets.QPushButton(self.wiz_page_sim_offsets)
        self.btn_set.setGeometry(QtCore.QRect(160, 200, 75, 23))
        self.btn_set.setObjectName("btn_set")
        self.btn_find = QtWidgets.QPushButton(self.wiz_page_sim_offsets)
        self.btn_find.setEnabled(False)
        self.btn_find.setGeometry(QtCore.QRect(240, 130, 75, 23))
    ...
    def retranslateUi(self, ObjectWizard):
        ...
        self.wiz_page_sim_offsets.setSubTitle(
            _translate("ObjectWizard", "Input offets to align object in simulated enviroment. "))
        ...
        self.btn_set.setText(_translate("ObjectWizard", "Set"))
