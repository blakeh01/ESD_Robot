...
class Ui_ObjectWizard(object):
    def setupUi(self, ObjectWizard):
        ...
        ObjectWizard.setOptions(
            QtWidgets.QWizard.HelpButtonOnRight | QtWidgets.QWizard.IndependentPages | QtWidgets.QWizard.NoCancelButton)
        ...
        ObjectWizard.setTabOrder(self.sbox_import_Z, self.sbox_prim_field_A)
        ...
        ObjectWizard.setTabOrder(self.sbox_prim_field_C, self.rbtn_prim_rect)
        ...
        ObjectWizard.setTabOrder(self.rbtn_prim_sphere, self.txt_path)
        ObjectWizard.setTabOrder(self.txt_path, self.btn_prompt_path)
        ObjectWizard.setTabOrder(self.btn_prompt_path, self.rbt_primitive)
        ...
        ObjectWizard.setTabOrder(self.rbt_scan_obj, self.sbox_import_X)
        ObjectWizard.setTabOrder(self.sbox_import_X, self.rbtn_import_units)
        ObjectWizard.setTabOrder(self.rbtn_import_units, self.rbtn_import_scale)
        ObjectWizard.setTabOrder(self.rbtn_import_scale, self.tabWidget)
        ObjectWizard.setTabOrder(self.tabWidget, self.sbox_offset_x)
        ...
        ObjectWizard.setTabOrder(self.sbox_offset_z, self.sbox_scan_y)
        ObjectWizard.setTabOrder(self.sbox_scan_y, self.sbox_scan_z)
        ObjectWizard.setTabOrder(self.sbox_scan_z, self.btn_find)
        ObjectWizard.setTabOrder(self.btn_find, self.sbox_scan_x)
        ObjectWizard.setTabOrder(self.sbox_scan_x, self.sbox_rbt_offset_x)
    ...
    def retranslateUi(self, ObjectWizard):
        ...
        self.wiz_page_import_obj.setSubTitle(
            _translate("ObjectWizard", "Select a path to an object file (.stl/.obj)..."))
        ...
        self.wiz_page_scan_obj.setSubTitle(
            _translate("ObjectWizard", "Enter object dimensions to scan object... NOTE: this takes a long time!"))
        ...
        self.wiz_page_visualize_obj.setSubTitle(
            _translate("ObjectWizard", "Ensure object has been properly imported into Open3D enviroment..."))
        self.wiz_page_sim_offsets.setTitle(_translate("ObjectWizard", "Set Object Offests"))
        self.wiz_page_sim_offsets.setSubTitle(_translate("ObjectWizard",
                                                         "Input offets to align object in simulated enviroment. You can also modify the robot offsets, but this is not recommneded unless you know what you are doing. "))
